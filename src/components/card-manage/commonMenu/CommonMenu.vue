...
<script lang="ts">
import { defineComponent, ref, computed, nextTick, type PropType, type Ref, watch, onUnmounted } from 'vue';
...
.__menu__wrapper {
    ...
    --menu-item-hoverBackground: rgba(237, 239, 243, 0.8);
