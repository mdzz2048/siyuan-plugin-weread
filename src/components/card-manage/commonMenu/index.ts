// REF: https://github.com/leon-kfd/howdyjs/tree/master/packages/mouse-menu

import { type App, type DirectiveBinding, createVNode, render, type ComponentPublicInstance, type ObjectDirective } from 'vue';
import type { CustomMouseMenuOptions, TouchListenFn, PreventCheckFn, ContextMenuListenFn } from './type';
import MouseMenu from './CommonMenu.vue';
